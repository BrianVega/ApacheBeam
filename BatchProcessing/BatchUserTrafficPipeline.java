...
public class BatchUserTrafficPipeline {
    ...
    public static PipelineResult run(Options options) {
        ...
        pipeline
                ...
                .apply("GroupFieldsById", Group.<CommonLog>byFieldNames("user_id")
                    .aggregateField("num_bytes", Count.combineFn() , "TotalNumOfBytes")
                    .aggregateField("num_bytes", Sum.ofLongs(), "TotalSumOfBytes")
                    .aggregateField("num_bytes", Max.ofLongs(), "MaxValueOfBytes")
                    .aggregateField("num_bytes", Min.ofLongs(), "MinValueOfBytes"))
                // .apply(Select.fieldNames("key.user_id", "value.TotalNumOfBytes", "value.MaxValueOfBytes", "value.MinValueOfBytes"))
                .apply("WriteToBQ",
